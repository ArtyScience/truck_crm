...
import { AdjustmentsIcon, BellIcon, MoonIcon, SunIcon } from '@heroicons/vue/solid'
...
export default {
    ...
    components: {
        AdjustmentsIcon, BellIcon, MoonIcon, SunIcon
    },
    methods: {
        changeTheme() {
        ...
        openModal() {
            if (!this.show) {
                this.show = true
                setTimeout(() => { this.addEvent('click', this.clickOutside) }, 150)
            }
        },
        openNotifications() {
        },
